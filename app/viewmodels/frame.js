...
define(['plugins/http', 'durandal/app', 'knockout', 'gridstack', 'lodash', 'state', 'store', 'panzoom'],
    ...
    var frame = function(){
        ...
        this.frame_config_map = [
            ...
            'card_dit:edit_one_at_a_time',
            'card_dit:expand_one_at_a_time',
            'expand_when_editing',
            'edit_on_sc_editable',
        ...
        this.home = {};
        this.home.ids = [];//array of card ids
        this.home.key = ko.observable('home');
        this.home.cards = this.cards;

        this.frameview = this.home;
